...
export const HOST = "https://adityashop123.myshopify.com/api/2023-04/graphql.json"
 ...
 */
	...
	["Article"]: AliasType<{
		...
		comments?: [{	/** Returns up to the first `n` elements from the list. */
			...
			reverse?: boolean | undefined | null | Variable<any, string>
		}, ValueTypes["CommentConnection"]],
		content?: [{	/** Truncates string after the given length. */
			truncateAt?: number | undefined | null | Variable<any, string>
		}, boolean | `@${string}`],
	 ...
	 */
		...
		metafields?: [{	/** The list of metafields to retrieve by namespace and key. */
			identifiers: Array<ValueTypes["HasMetafieldsIdentifier"]> | Variable<any, string>
		}, ValueTypes["Metafield"]],
 ...
 */
	["Cart"]: AliasType<{
		...
		deliveryGroups?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null | Variable<any, string>,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null | Variable<any, string>
		}, ValueTypes["CartDeliveryGroupConnection"]],
 ...
 */
	 ...
	 */
		...
		lineItems?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null | Variable<any, string>,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null | Variable<any, string>
		}, ValueTypes["CheckoutLineItemConnection"]],
 ...
 */
	 ...
	 */
		...
		products?: [{	/** Returns up to the first `n` elements from the list. */
			...
			filters?: Array<ValueTypes["ProductFilter"]> | undefined | null | Variable<any, string>
 ...
 */
	...
	["Customer"]: AliasType<{
		...
		addresses?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null | Variable<any, string>,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null | Variable<any, string>
		}, ValueTypes["MailingAddressConnection"]],
 ...
 */
	...
	["DeliveryAddress"]: AliasType<{
		["...on MailingAddress"]: ValueTypes["MailingAddress"]
		__typename?: boolean | `@${string}`
	}>;
 ...
 */
	 ...
	 */
		...
		url?: [{	/** A set of options to transform the original image. */
			transform?: ValueTypes["ImageTransformInput"] | undefined | null | Variable<any, string>
		}, boolean | `@${string}`],
 ...
 */
	 ...
	 */
		...
		formatted?: [{	/** Whether to include the customer's name in the formatted address. */
			...
			withCompany?: boolean | undefined | null | Variable<any, string>
		}, boolean | `@${string}`],
 ...
 */
	["Metafield"]: AliasType<{
		...
		}, ValueTypes["MetafieldReferenceConnection"]],
 ...
 */
	...
	["Mutation"]: AliasType<{
		...
		}, ValueTypes["CartAttributesUpdatePayload"]],
...
Buyer identity should match the customer's shipping address.
 */
			buyerIdentity: ValueTypes["CartBuyerIdentityInput"] | Variable<any, string>
		}, ValueTypes["CartBuyerIdentityUpdatePayload"]],
		cartCreate?: [{	/** The fields used to create a cart. */
			input?: ValueTypes["CartInput"] | undefined | null | Variable<any, string>
		}, ValueTypes["CartCreatePayload"]],
 ...
 */
		...
		checkoutCompleteWithCreditCardV2?: [{	/** The ID of the checkout. */
			...
			payment: ValueTypes["CreditCardPaymentInputV2"] | Variable<any, string>
		}, ValueTypes["CheckoutCompleteWithCreditCardV2Payload"]],
		checkoutCompleteWithTokenizedPaymentV3?: [{	/** The ID of the checkout. */
			...
			payment: ValueTypes["TokenizedPaymentInputV3"] | Variable<any, string>
		}, ValueTypes["CheckoutCompleteWithTokenizedPaymentV3Payload"]],
		checkoutCreate?: [{	/** The fields used to create a checkout. */
			...
			queueToken?: string | undefined | null | Variable<any, string>
		}, ValueTypes["CheckoutCreatePayload"]],
		...
		}, ValueTypes["CheckoutCustomerAssociateV2Payload"]],
		checkoutCustomerDisassociateV2?: [{	/** The ID of the checkout. */
			checkoutId: string | Variable<any, string>
		}, ValueTypes["CheckoutCustomerDisassociateV2Payload"]],
		...
		checkoutGiftCardRemoveV2?: [{	/** The ID of the Applied Gift Card to remove from the Checkout. */
			...
			checkoutId: string | Variable<any, string>
		}, ValueTypes["CheckoutGiftCardRemoveV2Payload"]],
		checkoutGiftCardsAppend?: [{	/** A list of gift card codes to append to the checkout. */
			...
			checkoutId: string | Variable<any, string>
		}, ValueTypes["CheckoutGiftCardsAppendPayload"]],
		checkoutLineItemsAdd?: [{	/** A list of line item objects to add to the checkout. */
			...
			checkoutId: string | Variable<any, string>
		}, ValueTypes["CheckoutLineItemsAddPayload"]],
		checkoutLineItemsRemove?: [{	/** The checkout on which to remove line items. */
			...
			lineItemIds: Array<string> | Variable<any, string>
		}, ValueTypes["CheckoutLineItemsRemovePayload"]],
		checkoutLineItemsReplace?: [{	/** A list of line item objects to set on the checkout. */
			lineItems: Array<ValueTypes["CheckoutLineItemInput"]> | Variable<any, string>,	/** The ID of the checkout. */
			checkoutId: string | Variable<any, string>
		}, ValueTypes["CheckoutLineItemsReplacePayload"]],
		checkoutLineItemsUpdate?: [{	/** The checkout on which to update line items. */
			...
			lineItems: Array<ValueTypes["CheckoutLineItemUpdateInput"]> | Variable<any, string>
		}, ValueTypes["CheckoutLineItemsUpdatePayload"]],
		checkoutShippingAddressUpdateV2?: [{	/** The shipping address to where the line items will be shipped. */
			...
			checkoutId: string | Variable<any, string>
		}, ValueTypes["CheckoutShippingAddressUpdateV2Payload"]],
		checkoutShippingLineUpdate?: [{	/** The ID of the checkout. */
			...
			shippingRateHandle: string | Variable<any, string>
		}, ValueTypes["CheckoutShippingLineUpdatePayload"]],
		customerAccessTokenCreate?: [{	/** The fields used to create a customer access token. */
			input: ValueTypes["CustomerAccessTokenCreateInput"] | Variable<any, string>
		}, ValueTypes["CustomerAccessTokenCreatePayload"]],
		customerAccessTokenCreateWithMultipass?: [{	/** A valid [multipass token](https://shopify.dev/api/multipass) to be authenticated. */
			multipassToken: string | Variable<any, string>
		}, ValueTypes["CustomerAccessTokenCreateWithMultipassPayload"]],
		customerAccessTokenDelete?: [{	/** The access token used to identify the customer. */
			customerAccessToken: string | Variable<any, string>
		}, ValueTypes["CustomerAccessTokenDeletePayload"]],
		customerAccessTokenRenew?: [{	/** The access token used to identify the customer. */
			customerAccessToken: string | Variable<any, string>
		}, ValueTypes["CustomerAccessTokenRenewPayload"]],
		customerActivate?: [{	/** Specifies the customer to activate. */
			id: string | Variable<any, string>,	/** The fields used to activate a customer. */
			input: ValueTypes["CustomerActivateInput"] | Variable<any, string>
		}, ValueTypes["CustomerActivatePayload"]],
		customerActivateByUrl?: [{	/** The customer activation URL. */
			...
			password: string | Variable<any, string>
		}, ValueTypes["CustomerActivateByUrlPayload"]],
		customerAddressCreate?: [{	/** The access token used to identify the customer. */
			...
			address: ValueTypes["MailingAddressInput"] | Variable<any, string>
		}, ValueTypes["CustomerAddressCreatePayload"]],
		customerAddressDelete?: [{	/** Specifies the address to delete. */
			...
			customerAccessToken: string | Variable<any, string>
		}, ValueTypes["CustomerAddressDeletePayload"]],
		customerAddressUpdate?: [{	/** The access token used to identify the customer. */
			...
			address: ValueTypes["MailingAddressInput"] | Variable<any, string>
		}, ValueTypes["CustomerAddressUpdatePayload"]],
		customerCreate?: [{	/** The fields used to create a new customer. */
			input: ValueTypes["CustomerCreateInput"] | Variable<any, string>
		...
		customerDefaultAddressUpdate?: [{	/** The access token used to identify the customer. */
			...
			addressId: string | Variable<any, string>
		}, ValueTypes["CustomerDefaultAddressUpdatePayload"]],
		customerRecover?: [{	/** The email address of the customer to recover. */
			email: string | Variable<any, string>
		}, ValueTypes["CustomerRecoverPayload"]],
		customerReset?: [{	/** Specifies the customer to reset. */
			...
			input: ValueTypes["CustomerResetInput"] | Variable<any, string>
		}, ValueTypes["CustomerResetPayload"]],
		customerResetByUrl?: [{	/** The customer's reset password url. */
			...
			password: string | Variable<any, string>
		}, ValueTypes["CustomerResetByUrlPayload"]],
		customerUpdate?: [{	/** The access token used to identify the customer. */
			...
			customer: ValueTypes["CustomerUpdateInput"] | Variable<any, string>
 ...
 */
	...
	["Order"]: AliasType<{
		...
		lineItems?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null | Variable<any, string>,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null | Variable<any, string>
		}, ValueTypes["OrderLineItemConnection"]],
		metafield?: [{	/** A container for a set of metafields. */
			namespace: string | Variable<any, string>,	/** The identifier for the metafield. */
			key: string | Variable<any, string>
		}, ValueTypes["Metafield"]],
...
For example, a digital download (such as a movie, music or ebook file) also qualifies as a product, as do services (such as equipment rental, work for hire, customization of another product or an extended warranty). */
	 ...
	 */
		...
		images?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null | Variable<any, string>,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null | Variable<any, string>,	/** Sort the underlying list by the given key. */
			sortKey?: ValueTypes["ProductImageSortKeys"] | undefined | null | Variable<any, string>
		...
		media?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null | Variable<any, string>,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null | Variable<any, string>,	/** Sort the underlying list by the given key. */
			sortKey?: ValueTypes["ProductMediaSortKeys"] | undefined | null | Variable<any, string>
	 ...
	 */
		...
		variantBySelectedOptions?: [{	/** The input fields used for a selected option. */
			selectedOptions: Array<ValueTypes["SelectedOptionInput"]> | Variable<any, string>
		...
		variants?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null | Variable<any, string>,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null | Variable<any, string>,	/** Sort the underlying list by the given key. */
			sortKey?: ValueTypes["ProductVariantSortKeys"] | undefined | null | Variable<any, string>
 ...
 */
	 ...
	 */
		...
		sellingPlanAllocations?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null | Variable<any, string>,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null | Variable<any, string>
		}, ValueTypes["SellingPlanAllocationConnection"]],
		...
		storeAvailability?: [{	/** Returns up to the first `n` elements from the list. */
			...
			near?: ValueTypes["GeoCoordinateInput"] | undefined | null | Variable<any, string>
		}, ValueTypes["StoreAvailabilityConnection"]],
 ...
 */
		...
		metaobject?: [{	/** The ID of the metaobject. */
			...
			handle?: ValueTypes["MetaobjectHandleInput"] | undefined | null | Variable<any, string>
		}, ValueTypes["Metaobject"]],
		metaobjects?: [{	/** The type of metaobject to retrieve. */
			...
			before?: string | undefined | null | Variable<any, string>,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null | Variable<any, string>
		}, ValueTypes["MetaobjectConnection"]],
...
Individual selling plans contribute their options to the associated selling plan group. For example, a selling plan group might have an option called `option1: Delivery every`. One selling plan in that group could contribute `option1: 2 weeks` with the pricing for that option, and another selling plan could contribute `option1: 4 weeks`, with different pricing. */
	...
	["SellingPlanPriceAdjustmentValue"]: AliasType<{
		["...on SellingPlanFixedAmountPriceAdjustment"]: ValueTypes["SellingPlanFixedAmountPriceAdjustment"],
 ...
 */
	...
	["Article"]: AliasType<{
		...
		content?: [{	/** Truncates string after the given length. */
			truncateAt?: number | undefined | null
		}, boolean | `@${string}`],
		/** The content of the article, complete with HTML formatting. */
		contentHtml?: boolean | `@${string}`,
		excerpt?: [{	/** Truncates string after the given length. */
	 ...
	 */
		...
		metafield?: [{	/** A container for a set of metafields. */
			...
			key: string
		}, ResolverInputTypes["Metafield"]],
		metafields?: [{	/** The list of metafields to retrieve by namespace and key. */
			identifiers: Array<ResolverInputTypes["HasMetafieldsIdentifier"]>
		}, ResolverInputTypes["Metafield"]],
		/** The URL used for viewing the resource on the shop's Online Store. Returns `null` if the resource is currently not published to the Online Store sales channel. */
		onlineStoreUrl?: boolean | `@${string}`,
		/** The date and time when the article was published. */
 ...
 */
		...
		}, ResolverInputTypes["ArticleConnection"]],
		/** The authors who have contributed to the blog. */
 ...
 */
	["Cart"]: AliasType<{
		...
		deliveryGroups?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["CartDeliveryGroupConnection"]],
		/** The discounts that have been applied to the entire cart. */
	 ...
	 */
		...
		lines?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["CartLineConnection"]],
		/** A note that is associated with the cart. For example, the note can be a personalized message to the buyer. */
		note?: boolean | `@${string}`,
		/** The total number of items in the cart. */
		totalQuantity?: boolean | `@${string}`,
 ...
 */
	 ...
	 */
		...
		discountApplications?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["DiscountApplicationConnection"]],
		/** The email attached to this checkout. */
		email?: boolean | `@${string}`,
		/** A globally-unique ID. */
		id?: boolean | `@${string}`,
		lineItems?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["CheckoutLineItemConnection"]],
		/** The sum of all the prices of all the items in the checkout. Duties, taxes, shipping and discounts excluded. */
 ...
 */
	 ...
	 */
		...
		products?: [{	/** Returns up to the first `n` elements from the list. */
			...
			filters?: Array<ResolverInputTypes["ProductFilter"]> | undefined | null
		}, ResolverInputTypes["ProductConnection"]],
		/** The collection's SEO information. */
		seo?: ResolverInputTypes["SEO"],
		/** The collection’s name. Limit of 255 characters. */
		title?: boolean | `@${string}`,
 ...
 */
	...
	["Customer"]: AliasType<{
		...
		addresses?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["MailingAddressConnection"]],
		/** The date and time when the customer was created. */
		createdAt?: boolean | `@${string}`,
		/** The customer’s default address. */
 ...
 */
			query?: string | undefined | null
		}, ResolverInputTypes["OrderConnection"]],
		/** The customer’s phone number. */
		phone?: boolean | `@${string}`,
		/** A comma separated list of tags that have been added to the customer.
	Additional access scope required: unauthenticated_read_customer_tags.
 ...
 */
	...
	["Fulfillment"]: AliasType<{
		fulfillmentLineItems?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["FulfillmentLineItemConnection"]],
		/** The name of the tracking company. */
		trackingCompany?: boolean | `@${string}`,
		trackingInfo?: [{	/** Truncate the array result to this size. */
			first?: number | undefined | null
		}, ResolverInputTypes["FulfillmentTrackingInfo"]],
		__typename?: boolean | `@${string}`
	}>;
	/** Represents a single line item in a fulfillment. There is at most one fulfillment line item for each order line item. */
	["FulfillmentLineItem"]: AliasType<{
 ...
 */
	 ...
	 */
		...
		url?: [{	/** A set of options to transform the original image. */
			transform?: ResolverInputTypes["ImageTransformInput"] | undefined | null
		}, boolean | `@${string}`],
		/** The original width of the image in pixels. Returns `null` if the image is not hosted by Shopify. */
		width?: boolean | `@${string}`,
		__typename?: boolean | `@${string}`
 ...
 */
	 ...
	 */
		...
		formatted?: [{	/** Whether to include the customer's name in the formatted address. */
			...
			withCompany?: boolean | undefined | null
		}, boolean | `@${string}`],
		/** A comma-separated list of the values for city, province, and country. */
		formattedArea?: boolean | `@${string}`,
		/** A globally-unique ID. */
 ...
 */
	["Metafield"]: AliasType<{
		...
		}, ResolverInputTypes["MetafieldReferenceConnection"]],
		/** The type name of the metafield.
	Refer to the list of [supported types](https://shopify.dev/apps/metafields/definitions/types).
	 */
		type?: boolean | `@${string}`,
 ...
 */
	...
	["Metaobject"]: AliasType<{
		field?: [{	/** The key of the field. */
			key: string
		}, ResolverInputTypes["MetaobjectField"]],
		/** All object fields with defined values.
	Omitted object keys can be assumed null, and no guarantees are made about field order.
	 */
 ...
 */
	...
	["Mutation"]: AliasType<{
		cartAttributesUpdate?: [{	/** An array of key-value pairs that contains additional information about the cart. */
			...
			cartId: string
		}, ResolverInputTypes["CartAttributesUpdatePayload"]],
		cartBuyerIdentityUpdate?: [{	/** The ID of the cart. */
			cartId: string,	/** The customer associated with the cart. Used to determine
[international pricing](https://shopify.dev/custom-storefronts/internationalization/international-pricing).
Buyer identity should match the customer's shipping address.
 */
			buyerIdentity: ResolverInputTypes["CartBuyerIdentityInput"]
		}, ResolverInputTypes["CartBuyerIdentityUpdatePayload"]],
		cartCreate?: [{	/** The fields used to create a cart. */
			input?: ResolverInputTypes["CartInput"] | undefined | null
		}, ResolverInputTypes["CartCreatePayload"]],
		cartDiscountCodesUpdate?: [{	/** The ID of the cart. */
 ...
 */
		...
		cartLinesAdd?: [{	/** A list of merchandise lines to add to the cart. */
			...
			cartId: string
		}, ResolverInputTypes["CartLinesAddPayload"]],
		cartLinesRemove?: [{	/** The ID of the cart. */
			cartId: string,	/** The merchandise line IDs to remove. */
			lineIds: Array<string>
		}, ResolverInputTypes["CartLinesRemovePayload"]],
		cartLinesUpdate?: [{	/** The ID of the cart. */
			cartId: string,	/** The merchandise lines to update. */
			lines: Array<ResolverInputTypes["CartLineUpdateInput"]>
		}, ResolverInputTypes["CartLinesUpdatePayload"]],
		cartNoteUpdate?: [{	/** The ID of the cart. */
			cartId: string,	/** The note on the cart. */
			note?: string | undefined | null
		}, ResolverInputTypes["CartNoteUpdatePayload"]],
		cartSelectedDeliveryOptionsUpdate?: [{	/** The ID of the cart. */
			cartId: string,	/** The selected delivery options. */
			selectedDeliveryOptions: Array<ResolverInputTypes["CartSelectedDeliveryOptionInput"]>
		}, ResolverInputTypes["CartSelectedDeliveryOptionsUpdatePayload"]],
		checkoutAttributesUpdateV2?: [{	/** The ID of the checkout. */
			checkoutId: string,	/** The checkout attributes to update. */
			input: ResolverInputTypes["CheckoutAttributesUpdateV2Input"]
		}, ResolverInputTypes["CheckoutAttributesUpdateV2Payload"]],
		checkoutCompleteFree?: [{	/** The ID of the checkout. */
			checkoutId: string
		}, ResolverInputTypes["CheckoutCompleteFreePayload"]],
		checkoutCompleteWithCreditCardV2?: [{	/** The ID of the checkout. */
			checkoutId: string,	/** The credit card info to apply as a payment. */
			payment: ResolverInputTypes["CreditCardPaymentInputV2"]
		}, ResolverInputTypes["CheckoutCompleteWithCreditCardV2Payload"]],
		checkoutCompleteWithTokenizedPaymentV3?: [{	/** The ID of the checkout. */
			checkoutId: string,	/** The info to apply as a tokenized payment. */
			payment: ResolverInputTypes["TokenizedPaymentInputV3"]
		}, ResolverInputTypes["CheckoutCompleteWithTokenizedPaymentV3Payload"]],
		checkoutCreate?: [{	/** The fields used to create a checkout. */
		...
		}, ResolverInputTypes["CheckoutCreatePayload"]],
		checkoutCustomerAssociateV2?: [{	/** The ID of the checkout. */
			checkoutId: string,	/** The customer access token of the customer to associate. */
			customerAccessToken: string
		}, ResolverInputTypes["CheckoutCustomerAssociateV2Payload"]],
		checkoutCustomerDisassociateV2?: [{	/** The ID of the checkout. */
			checkoutId: string
		}, ResolverInputTypes["CheckoutCustomerDisassociateV2Payload"]],
		checkoutDiscountCodeApplyV2?: [{	/** The discount code to apply to the checkout. */
			discountCode: string,	/** The ID of the checkout. */
			checkoutId: string
		}, ResolverInputTypes["CheckoutDiscountCodeApplyV2Payload"]],
		checkoutDiscountCodeRemove?: [{	/** The ID of the checkout. */
			checkoutId: string
		}, ResolverInputTypes["CheckoutDiscountCodeRemovePayload"]],
		checkoutEmailUpdateV2?: [{	/** The ID of the checkout. */
			checkoutId: string,	/** The email to update the checkout with. */
			email: string
		}, ResolverInputTypes["CheckoutEmailUpdateV2Payload"]],
		checkoutGiftCardRemoveV2?: [{	/** The ID of the Applied Gift Card to remove from the Checkout. */
			appliedGiftCardId: string,	/** The ID of the checkout. */
			checkoutId: string
		}, ResolverInputTypes["CheckoutGiftCardRemoveV2Payload"]],
		checkoutGiftCardsAppend?: [{	/** A list of gift card codes to append to the checkout. */
			giftCardCodes: Array<string>,	/** The ID of the checkout. */
			checkoutId: string
		}, ResolverInputTypes["CheckoutGiftCardsAppendPayload"]],
		checkoutLineItemsAdd?: [{	/** A list of line item objects to add to the checkout. */
			lineItems: Array<ResolverInputTypes["CheckoutLineItemInput"]>,	/** The ID of the checkout. */
			checkoutId: string
		}, ResolverInputTypes["CheckoutLineItemsAddPayload"]],
		checkoutLineItemsRemove?: [{	/** The checkout on which to remove line items. */
			checkoutId: string,	/** Line item ids to remove. */
			lineItemIds: Array<string>
		}, ResolverInputTypes["CheckoutLineItemsRemovePayload"]],
		checkoutLineItemsReplace?: [{	/** A list of line item objects to set on the checkout. */
			lineItems: Array<ResolverInputTypes["CheckoutLineItemInput"]>,	/** The ID of the checkout. */
			checkoutId: string
		}, ResolverInputTypes["CheckoutLineItemsReplacePayload"]],
		checkoutLineItemsUpdate?: [{	/** The checkout on which to update line items. */
			checkoutId: string,	/** Line items to update. */
			lineItems: Array<ResolverInputTypes["CheckoutLineItemUpdateInput"]>
		}, ResolverInputTypes["CheckoutLineItemsUpdatePayload"]],
		checkoutShippingAddressUpdateV2?: [{	/** The shipping address to where the line items will be shipped. */
			shippingAddress: ResolverInputTypes["MailingAddressInput"],	/** The ID of the checkout. */
			checkoutId: string
		}, ResolverInputTypes["CheckoutShippingAddressUpdateV2Payload"]],
		checkoutShippingLineUpdate?: [{	/** The ID of the checkout. */
		...
		}, ResolverInputTypes["CheckoutShippingLineUpdatePayload"]],
		customerAccessTokenCreate?: [{	/** The fields used to create a customer access token. */
			input: ResolverInputTypes["CustomerAccessTokenCreateInput"]
		}, ResolverInputTypes["CustomerAccessTokenCreatePayload"]],
		customerAccessTokenCreateWithMultipass?: [{	/** A valid [multipass token](https://shopify.dev/api/multipass) to be authenticated. */
			multipassToken: string
		}, ResolverInputTypes["CustomerAccessTokenCreateWithMultipassPayload"]],
		customerAccessTokenDelete?: [{	/** The access token used to identify the customer. */
			customerAccessToken: string
		}, ResolverInputTypes["CustomerAccessTokenDeletePayload"]],
		customerAccessTokenRenew?: [{	/** The access token used to identify the customer. */
			customerAccessToken: string
		}, ResolverInputTypes["CustomerAccessTokenRenewPayload"]],
		customerActivate?: [{	/** Specifies the customer to activate. */
			id: string,	/** The fields used to activate a customer. */
			input: ResolverInputTypes["CustomerActivateInput"]
		}, ResolverInputTypes["CustomerActivatePayload"]],
		customerActivateByUrl?: [{	/** The customer activation URL. */
			activationUrl: ResolverInputTypes["URL"],	/** A new password set during activation. */
			password: string
		}, ResolverInputTypes["CustomerActivateByUrlPayload"]],
		customerAddressCreate?: [{	/** The access token used to identify the customer. */
			customerAccessToken: string,	/** The customer mailing address to create. */
			address: ResolverInputTypes["MailingAddressInput"]
		}, ResolverInputTypes["CustomerAddressCreatePayload"]],
		customerAddressDelete?: [{	/** Specifies the address to delete. */
			id: string,	/** The access token used to identify the customer. */
			customerAccessToken: string
		}, ResolverInputTypes["CustomerAddressDeletePayload"]],
		customerAddressUpdate?: [{	/** The access token used to identify the customer. */
			customerAccessToken: string,	/** Specifies the customer address to update. */
			id: string,	/** The customer’s mailing address. */
			address: ResolverInputTypes["MailingAddressInput"]
		}, ResolverInputTypes["CustomerAddressUpdatePayload"]],
		customerCreate?: [{	/** The fields used to create a new customer. */
			input: ResolverInputTypes["CustomerCreateInput"]
		}, ResolverInputTypes["CustomerCreatePayload"]],
		customerDefaultAddressUpdate?: [{	/** The access token used to identify the customer. */
			customerAccessToken: string,	/** ID of the address to set as the new default for the customer. */
			addressId: string
		}, ResolverInputTypes["CustomerDefaultAddressUpdatePayload"]],
		customerRecover?: [{	/** The email address of the customer to recover. */
			email: string
		}, ResolverInputTypes["CustomerRecoverPayload"]],
		customerReset?: [{	/** Specifies the customer to reset. */
			id: string,	/** The fields used to reset a customer’s password. */
			input: ResolverInputTypes["CustomerResetInput"]
		}, ResolverInputTypes["CustomerResetPayload"]],
		customerResetByUrl?: [{	/** The customer's reset password url. */
			resetUrl: ResolverInputTypes["URL"],	/** New password that will be set as part of the reset password process. */
			password: string
		}, ResolverInputTypes["CustomerResetByUrlPayload"]],
		customerUpdate?: [{	/** The access token used to identify the customer. */
			customerAccessToken: string,	/** The customer object input. */
			customer: ResolverInputTypes["CustomerUpdateInput"]
		}, ResolverInputTypes["CustomerUpdatePayload"]],
		__typename?: boolean | `@${string}`
	}>;
	/** An object with an ID field to support global identification, in accordance with the
[Relay specification](https://relay.dev/graphql/objectidentification.htm#sec-Node-Interface).
 ...
 */
	...
	["Order"]: AliasType<{
		...
		lineItems?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["OrderLineItemConnection"]],
		metafield?: [{	/** A container for a set of metafields. */
			namespace: string,	/** The identifier for the metafield. */
			key: string
		}, ResolverInputTypes["Metafield"]],
	 ...
	 */
		...
		successfulFulfillments?: [{	/** Truncate the array result to this size. */
			first?: number | undefined | null
		}, ResolverInputTypes["Fulfillment"]],
		/** The sum of all the prices of all the items in the order, duties, taxes and discounts included (must be positive). */
		totalPrice?: ResolverInputTypes["MoneyV2"],
		/** The sum of all the prices of all the items in the order, duties, taxes and discounts included (must be positive). */
		totalPriceV2?: ResolverInputTypes["MoneyV2"],
...
For example, a digital download (such as a movie, music or ebook file) also qualifies as a product, as do services (such as equipment rental, work for hire, customization of another product or an extended warranty). */
	["Product"]: AliasType<{
		...
		collections?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["CollectionConnection"]],
		/** The compare at price of the product across all variants. */
	 ...
	 */
		...
		images?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null,	/** Sort the underlying list by the given key. */
			sortKey?: ResolverInputTypes["ProductImageSortKeys"] | undefined | null
		}, ResolverInputTypes["ImageConnection"]],
		/** Whether the product is a gift card. */
		isGiftCard?: boolean | `@${string}`,
		media?: [{	/** Returns up to the first `n` elements from the list. */
			first?: number | undefined | null,	/** Returns the elements that come after the specified cursor. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null,	/** Sort the underlying list by the given key. */
			sortKey?: ResolverInputTypes["ProductMediaSortKeys"] | undefined | null
		...
		options?: [{	/** Truncate the array result to this size. */
			first?: number | undefined | null
		}, ResolverInputTypes["ProductOption"]],
		/** The price range. */
		...
		sellingPlanGroups?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["SellingPlanGroupConnection"]],
		/** The product's SEO information. */
		seo?: ResolverInputTypes["SEO"],
		/** A comma separated list of tags that have been added to the product.
	Additional access scope required for private apps: unauthenticated_read_product_tags.
	 ...
	 */
		updatedAt?: boolean | `@${string}`,
		variantBySelectedOptions?: [{	/** The input fields used for a selected option. */
			selectedOptions: Array<ResolverInputTypes["SelectedOptionInput"]>
		}, ResolverInputTypes["ProductVariant"]],
		variants?: [{	/** Returns up to the first `n` elements from the list. */
			first?: number | undefined | null,	/** Returns the elements that come after the specified cursor. */
			after?: string | undefined | null,	/** Returns up to the last `n` elements from the list. */
			last?: number | undefined | null,	/** Returns the elements that come before the specified cursor. */
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null,	/** Sort the underlying list by the given key. */
			sortKey?: ResolverInputTypes["ProductVariantSortKeys"] | undefined | null
		}, ResolverInputTypes["ProductVariantConnection"]],
		/** The product’s vendor name. */
		vendor?: boolean | `@${string}`,
		__typename?: boolean | `@${string}`
	}>;
 ...
 */
	 ...
	 */
		...
		sellingPlanAllocations?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["SellingPlanAllocationConnection"]],
		/** The SKU (stock keeping unit) associated with the variant. */
		sku?: boolean | `@${string}`,
		storeAvailability?: [{	/** Returns up to the first `n` elements from the list. */
			first?: number | undefined | null,	/** Returns the elements that come after the specified cursor. */
			...
			near?: ResolverInputTypes["GeoCoordinateInput"] | undefined | null
		}, ResolverInputTypes["StoreAvailabilityConnection"]],
		/** The product variant’s title. */
		title?: boolean | `@${string}`,
		/** The unit price value for the variant based on the variant's measurement. */
		unitPrice?: ResolverInputTypes["MoneyV2"],
 ...
 */
			query?: string | undefined | null
		}, ResolverInputTypes["BlogConnection"]],
		cart?: [{	/** The ID of the cart. */
			id: string
		}, ResolverInputTypes["Cart"]],
		collection?: [{	/** The ID of the `Collection`. */
 ...
 */
		...
		locations?: [{	/** Returns up to the first `n` elements from the list. */
			...
			near?: ResolverInputTypes["GeoCoordinateInput"] | undefined | null
		}, ResolverInputTypes["LocationConnection"]],
		menu?: [{	/** The navigation menu's handle. */
			handle: string
		}, ResolverInputTypes["Menu"]],
		metaobject?: [{	/** The ID of the metaobject. */
			id?: string | undefined | null,	/** The handle and type of the metaobject. */
			handle?: ResolverInputTypes["MetaobjectHandleInput"] | undefined | null
		}, ResolverInputTypes["Metaobject"]],
		metaobjects?: [{	/** The type of metaobject to retrieve. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["MetaobjectConnection"]],
		node?: [{	/** The ID of the Node to return. */
			id: string
 ...
 */
			query?: string | undefined | null
		}, ResolverInputTypes["PageConnection"]],
		product?: [{	/** The ID of the `Product`. */
		...
		productTags?: [{	/** Returns up to the first `n` elements from the list. */
			first: number
		}, ResolverInputTypes["StringConnection"]],
		productTypes?: [{	/** Returns up to the first `n` elements from the list. */
			first: number
		}, ResolverInputTypes["StringConnection"]],
		products?: [{	/** Returns up to the first `n` elements from the list. */
 ...
 */
			query?: string | undefined | null
		}, ResolverInputTypes["UrlRedirectConnection"]],
		__typename?: boolean | `@${string}`
	}>;
	/** SEO information. */
	["SEO"]: AliasType<{
 ...
 */
	...
	["SellingPlanGroup"]: AliasType<{
		...
		sellingPlans?: [{	/** Returns up to the first `n` elements from the list. */
			...
			before?: string | undefined | null,	/** Reverse the order of the underlying list. */
			reverse?: boolean | undefined | null
		}, ResolverInputTypes["SellingPlanConnection"]],
		__typename?: boolean | `@${string}`
	}>;
	/** An auto-generated type for paginating through multiple SellingPlanGroups.
 */
